...
/* START Declare Exception Handlers */         	
  ...
  DECLARE EXIT HANDLER FOR SQLEXCEPTION
	  BEGIN
		...
		IF p_sqlstate_code <> '00000' or p_sqlcode <> 0 THEN
...
CALL ex06_23WithSignal('Madison', 'Pepper', 'Paula', 'Beaver')

CALL ex06_23WithSignal('Madison', 'Morales', 'John', 'Beaver')

CALL ex06_23WithSignal('Mar2025', 'Morales', 'John', 'XXXXXXX')

CALL ex06_23WithSignal('Mar2025', 'Morales', 'John', 'Beaver')